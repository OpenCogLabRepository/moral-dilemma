...
![Fig 1A. Example of control vignette.](images/c1.JPG?raw=true "Fig 1A. Example of control vignette.")Fig. 1A Example of a control vignette. *Does he make the basket?*

![Fig. 1B Example of a dilemma vignette.](images/d1.JPG?raw=true "Fig 1B. Example of dilemma vignette.")Fig. 1B Example of a dilemma vignette. *Would you push the chair?* To hang your son and save the lives of five other prisoners.
